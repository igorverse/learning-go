// Intefaces are named collections of method signatures
...
func main() {
	...
	// Both, circle and rect structs implement the geometry interface
	// so we can use instaces of these structs as arguments to measure
	measure(r)
	measure(c)
}
