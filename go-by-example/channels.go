...
// When we run the programa (go run channels.go), the "ping" message is
// successfully passed from one goroutine to another via our channel

// By default, sends and receives block until both the sender and receiver are ready.
// This property allows to wait the end of the program for the "ping" message
